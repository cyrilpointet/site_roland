<template>
  <div>
    <h4 class="text-xl mb-2">Chapitre 1</h4>
    <p>
    ...
    <h4 class="text-xl mb-2 mt-3">Chapitre 2</h4>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-3 gap-4">
      <p class="md:col-span-1 lg:col-span-2">
      ...
      <span>
        <figure>
          <img :src="imgUrl" alt="jolie photo" />
        </figure>
        <figcaption>Jolie photo</figcaption>
      </span>
    </div>

    <h4 class="text-xl mb-2 mt-3">Chapitre 3</h4>
    <p>
      ...
      et, hendrerit quis, nisi. Curabitur ligula sapien, tincidunt non, euismod
      vitae, posuere imperdiet, leo. Maecenas malesuada. Praesent congue erat at
      massa. Sed cursus turpis vitae tortor. Donec posuere vulputate arcu.
    </p>
    <h4 class="text-xl mb-2 mt-3">Chapitre 4</h4>
    <p>
